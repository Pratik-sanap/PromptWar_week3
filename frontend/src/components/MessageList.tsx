...
export const MessageList: React.FC<MessageListProps> = React.memo(({ messages, isTyping, error }) => {
    ...
    >
      {messages.length === 0 ? (
        <div className="empty-chat-state" role="status">
          ...
          <p>Select your zone, specify accessibility needs, and ask any question about navigation, crowds, or transport around the stadium.</p>
        </div>
      ) : (
        messages.map((msg) => (
